                ...
                <table class="form-table">
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <input type="number" id="insert_ads_after_word_count" name="insert_ads_after_word_count" value="<?php echo esc_attr(get_option('insert_ads_after_word_count', 50)); ?>" placeholder="Number of words" />
                        </td>
                    </tr>
                    <tr valign="top">
