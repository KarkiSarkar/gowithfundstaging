            ...
            <div id="ads_field" class="ads-tabcontent">
                <table class="form-table">
                    ...
                    <tr valign="top">
                        ...
                        <tr valign="top">
                            <th scope="row">Insert Ads in Between Posts</th>
                            <td>
                            <label class="ads-toggle-btn" for="insert_ads_in_between_content_enabled">
                                <input type="checkbox" id="insert_ads_in_between_content_enabled" name="insert_ads_in_between_content_enabled" value="1" <?php checked(1, get_option('insert_ads_in_between_content_enabled'), true); ?> />
                                <span class="ads-slider"></span>
                            </label>
                            </td>
                        </tr>
