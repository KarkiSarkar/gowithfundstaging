...
function register_facebook_messenger_chat_widget() {
    register_widget('Facebook_Messenger_Chat_Widget');
}
add_action('widgets_init', 'register_facebook_messenger_chat_widget');
class Facebook_Messenger_Chat_Widget extends WP_Widget {
    // Constructor
    public function __construct() {
        parent::__construct(
            'facebook_messenger_chat_widget', // Base ID
            'Facebook Messenger Chat Widget', // Name
            array('description' => __('A widget that displays a Facebook Messenger chat', 'text_domain'))
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        // Output the Facebook Messenger chat plugin
        echo '<div id="fb-root"></div>';
        echo '<div class="fb-customerchat" attribution=setup_tool page_id="' . esc_attr($page_id) . '"></div>';
